...
public class SelectionTaskMeasure : MonoBehaviour
{
    ...
    public void StartOneTask()
    {
        ...
        parkourCounter.locomotionTech.StartInteraction(targerT);
        parkourCounter.currentRespawnPos = Respawns[part].transform.position;
    }
    ...
    public void EndOneTask()
    {
        ...
        //parkourCounter.locomotionTech.EndInteraction();
    }
